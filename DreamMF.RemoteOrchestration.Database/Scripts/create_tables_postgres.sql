...
VALUES 
    ...
    -- Database Settings
    ('database:type', 'postgres', '2024-12-23T08:49:27-07:00', '2024-12-23T08:49:27-07:00'),
    ('database:host', 'localhost', '2024-12-23T08:49:27-07:00', '2024-12-23T08:49:27-07:00'),
    ('database:port', '5432', '2024-12-23T08:49:27-07:00', '2024-12-23T08:49:27-07:00'),
...
SELECT 
    ...
    COUNT(CASE 
        WHEN ar.Created_Date >= (CURRENT_TIMESTAMP - INTERVAL '30 days')
        THEN 1 
